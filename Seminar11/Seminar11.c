...
void inserareInNodP(NodP** lista, Masina m)
{
...
void inserareInListaS(NodS** lista, NodP* vecini)
{
...
void inserareMuchie(NodP* listaPrincipala, int idStart, int idStop) {
	...
	NodP* end = cautaNodDupaID(listaPrincipala, idStop);

	if (start != NULL && end != NULL)
	{
		inserareInListaS(&(start->vecini), end);
		inserareInListaS(&(end->vecini), start);
	}
}
